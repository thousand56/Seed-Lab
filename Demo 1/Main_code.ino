...
double forwardFeet = 9;
// Input turning distance in radians (left is positive)
double turningRad = 0;

// 1 ft forward is 502 encoder counts
// 90 degree turn is 282 encoder counts
...
forwardEncoder = forwardFeet * 502;
turningEncoder = turningRad * 282;
